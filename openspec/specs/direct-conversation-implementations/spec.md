...
Direct Conversation implementations (MemoryConversation, FileConversation) provide storage backends that implement Conversation without requiring DAO dependencies.
