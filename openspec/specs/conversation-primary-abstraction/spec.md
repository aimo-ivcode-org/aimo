...
Conversation is the primary abstraction for conversation storage in aimo-core. All implementations directly satisfy the Conversation interface without requiring wrapper layers.
