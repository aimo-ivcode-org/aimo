...
aimo.model.bedrock.claude-3-sonnet.context.size=200000
aimo.model.bedrock.claude-3-sonnet.context.excludeThinking=false
...
- `context.size` (default: `8192`) - Model context window size
- `context.excludeThinking` (default: `false`) - Exclude assistant thinking content from context-window budgeting and prompt history payload
